...
## Corpus Check
- 30 files · ~165,996 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 191 nodes · 304 edges · 19 communities (11 shown, 6 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 21 edges (avg confidence: 0.94)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6f53b6d5`
...
- `reset_to_default_chat()` --uses--> `RetrievalEngine`  [INFERRED]
...
Cohesion: 0.14
Nodes (22): get, post, display_results(), main(), Interactive Terminal Interface for ChatRecall…, Thread Context Engine for ChatRecall ====================================…, ThreadContextBuilder, ChatIndex (+14 more)
...
Cohesion: 0.20
Nodes (12): expand_query(), search(), load_custom_txt_to_json(), parse_chat_txt(), parse_timestamp(), Any, Text Chat Parser for ChatRecall =============================== Parses raw…, Parses a .txt file and saves it as structured JSON ready for indexing. (+4 more)
...
### Community 11 - "RetrievalEngine"
Cohesion: 0.21
Nodes (9): compute_metrics(), generate_markdown_report(), Any, Comprehensive Evaluation Runner for ChatRecall…, run_benchmark(), Any, Suppresses candidate messages whose context window overlaps significantly…, Executes query through multi-strategy routing, contextual vector search,… (+1 more)
...
- **Why does `ChatIndex` connect `ChatIndex` to `retrieve.py`, `MessageEmbedder`, `parse_chat_txt`, `run_demo_eval.py`, `RetrievalEngine`?**
  _High betweenness centrality (0.128) - this node is a cross-community bridge._
- **Why does `MessageEmbedder` connect `MessageEmbedder` to `ChatIndex`, `retrieve.py`?**
  _High betweenness centrality (0.079) - this node is a cross-community bridge._
- **Why does `RetrievalEngine` connect `RetrievalEngine` to `ChatIndex`, `run_demo_eval.py`, `retrieve.py`, `parse_chat_txt`?**
